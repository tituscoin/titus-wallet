...
- Which version of Titus Wallet are you using? (Check Titus Wallet version on the side menu)
...
- Please check Titus Wallet logs (General Settings -> About Titus Wallet -> Session Logs). Look for
  any errors reported there (errors are shown in red)
- If possible, please provide a screen shot of the error / issue.

If you need to provide personal / sensitive data to solve the issue (like the Wallet Id), do not use Github Issues.
We will provide a better channel (like an Titus email address) so you can send the information. If possible, please
...
Please adhere to the coding conventions used throughout Titus Wallet (indentation, tests, etc.)
