...
export class OnGoingProcessProvider {
  ...
  public getProccessNames() {
    const processNames = {
      ...
      buyingBitcoin: this.translate.instant('Buying Titus Coin...'),
      sellingBitcoin: this.translate.instant('Selling Titus Coin...'),
      fetchingBitPayAccount: this.translate.instant('Fetching Titus Account...'),
      fetchingBitPayCards: this.translate.instant('Fetching Titus Cards...'),
